...
void Board::display(void)
{
    ...
    std::cout << " 0 | " << getMark(0, 0) << " | " << getMark(0, 1) << " | " << getMark(0, 2) << " " << std::endl;
    std::cout << "---|---|---|---" << std::endl;
    std::cout << " 1 | " << getMark(1, 0) << " | " << getMark(1, 1) << " | " << getMark(1, 2) << " " << std::endl;
    std::cout << "---|---|---|---" << std::endl;
    std::cout << " 2 | " << getMark(2, 0) << " | " << getMark(2, 1) << " | " << getMark(2, 2) << " " << std::endl;
}
...
//! rassembler le tt dans une fonction
